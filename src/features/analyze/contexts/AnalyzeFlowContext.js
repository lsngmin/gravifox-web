...
const PLACEHOLDER_PREVIEW_DATA_URL = '/ss.png';
                ...
                scales: [
                  {
                    scale: 224,
                    scale_index: 0,
                    bbox: { x1: 0, y1: 0, x2: 0.33, y2: 0.33 },
                    scores: { ai: 0.22, real: 0.78, distribution: [0.78, 0.22] },
                  },
                ],
              },
              {
                ...
                scales: [
                  {
                    scale: 224,
                    scale_index: 0,
                    bbox: { x1: 0.33, y1: 0.33, x2: 0.66, y2: 0.66 },
                    scores: { ai: 0.28, real: 0.72, distribution: [0.72, 0.28] },
                  },
                  {
                    scale: 336,
                    scale_index: 1,
                    bbox: { x1: 0.25, y1: 0.25, x2: 0.75, y2: 0.75 },
                    scores: { ai: 0.46, real: 0.54, distribution: [0.54, 0.46] },
                  },
                ],
              },
              {
                ...
                scales: [
                  {
                    scale: 224,
                    scale_index: 0,
                    bbox: { x1: 0.66, y1: 0.66, x2: 1, y2: 1 },
                    scores: { ai: 0.15, real: 0.85, distribution: [0.85, 0.15] },
                  },
                ],
              },
            ],
