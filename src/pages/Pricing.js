    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="relative">
        ...
        <section className="relative overflow-hidden pt-24 sm:pt-28 lg:pt-32 pb-12">
          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 text-center mb-1">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/80 px-3 sm:px-4 py-1.5 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.25em] sm:tracking-[0.3em] text-indigo-600 shadow-sm ring-1 ring-indigo-200/60">
              {t('hero.ribbon', '공개 베타 안내')}
            </div>

            <h1 className="mt-3 sm:mt-4 text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-snug sm:leading-tight md:leading-tight">
              {t('hero.title', '지금은 무료 요금제로만 체험해 주세요')}
            </h1>

            <p className="mt-3 sm:mt-4 text-[13px] sm:text-sm md:text-base lg:text-lg text-slate-600 leading-relaxed sm:leading-normal max-w-2xl md:max-w-3xl mx-auto">
              {t(
                  'hero.subtitle',
        ...
        <section className="max-w-6xl mx-auto px-6 pb-24">
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="w-full">
              <div className="relative h-full rounded-2xl bg-gradient-to-br from-indigo-300/40 via-indigo-200/30 to-purple-200/30 p-[1px]">
                <motion.div
                    className="group rounded-2xl bg-gradient-to-br from-indigo-50/90 via-white/95 to-indigo-100/80 backdrop-blur-sm ring-1 ring-indigo-200/70 p-6 md:p-8 shadow-sm hover:shadow-lg transition-all flex flex-col h-full"
                    initial={getInitial(24)}
                    animate={animateProps}
                    transition={getTransition(0.03)}
                >
                  {/* 헤더 */}
                  <div className="mb-1 text-md font-semibold tracking-wide text-indigo-600">
                    {t('free.badge', 'Free')}
                  </div>
                  ...
                  <p className="mt-1 text-sm text-slate-600">
                    {t('free.subtitle', '베타 기간에도 제한 없이 활용해 보세요')}
                  </p>

                  {/* 안내 문구 */}
                  <p className="mt-3 text-xs font-medium text-indigo-600">
                    {t('free.betaMessage', '현재는 Basic 플랜을 통해 동일한 분석 기능을 경험해 주세요.')}
                  </p>
        ...
        <span className="text-3xl font-extrabold text-slate-900">
          {t('free.price', '₩0')}
                  ...
                  {/* 기능 목록 */}
                  <ul className="mt-6 space-y-3.5 text-sm text-slate-800">
                    <li className="flex items-center gap-3 group/item">
                      <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-emerald-100 to-indigo-100 ring-1 ring-slate-200">
                        <CircleCheck className="text-emerald-600" size={12} />
                      </div>
                      <span className="group-hover/item:text-indigo-700 transition-colors">
            {t('free.features.sessions', '일 10회 이미지 분석 세션 제공')}
          </span>
                    </li>

                    <li className="flex items-center gap-3 group/item">
                      <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-blue-100 to-purple-100 ring-1 ring-slate-200">
                        <BadgeCheck className="text-indigo-600" size={12} />
                      </div>
                      <span className="group-hover/item:text-indigo-700 transition-colors">
            {t('free.features.queue', '기본 우선순위 처리 큐')}
          </span>
                    </li>

                    <li className="flex items-center gap-3 group/item">
                      <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-violet-100 to-indigo-100 ring-1 ring-slate-200">
                        <Sparkles className="text-purple-600" size={12} />
                      </div>
                      <span className="group-hover/item:text-indigo-700 transition-colors">
            {t('free.features.metrics', '핵심 활용 지표 확인')}
          </span>
                    </li>

                    <li className="flex items-center gap-3 group/item">
                      <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-indigo-100 to-emerald-100 ring-1 ring-slate-200">
                        <Layers className="text-indigo-500" size={12} />
                      </div>
                      <span className="group-hover/item:text-indigo-700 transition-colors">
            {t('free.features.models', '대표 모델 체험')}
          </span>
                    </li>

                    {/* 새 항목: history */}
                    <li className="flex items-center gap-3 group/item">
                      <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-emerald-50 to-slate-50 ring-1 ring-slate-200">
                        <History className="text-emerald-500" size={12} />
                      </div>
                      <span className="group-hover/item:text-indigo-700 transition-colors">
            {t('free.features.history', '최근 분석 결과 이력 보기')}
          </span>
                    </li>
                  </ul>
                  ...
                  <div className="mt-auto pt-6">
                    <motion.a
                        href="/login"
                        className="inline-flex w-full items-center justify-center rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 hover:shadow-md transition-all"
            ...
            {/* Plus */}
            <div className="w-full">
              <div className="relative h-full rounded-2xl bg-gradient-to-br from-indigo-100/25 via-slate-50/80 to-white/60 p-[1px]">
                <motion.div
                    className="group rounded-2xl bg-gradient-to-br from-white/97 via-indigo-50/85 to-white/90 backdrop-blur-sm ring-1 ring-indigo-100/60 p-6 md:p-8 shadow-sm hover:shadow-lg transition-all flex flex-col h-full"
                    initial={getInitial(24)}
                    animate={animateProps}
                ...
                >
                  ...
                  {/*<h3 className="text-xl font-semibold text-slate-900">*/}
                  {/*  {t('plus.title', '플러스 요금제')}*/}
                  {/*</h3>*/}
                  <p className="mt-1 text-sm text-slate-600">
                    {t('plus.subtitle', '강화된 기능은 곧 공개돼요. 현재는 Free 플랜과 동일하게 이용해 주세요.')}
                  </p>

                  {/* 안내 문구 */}
                  <p className="mt-3 text-xs font-medium text-indigo-600">
                    {t('plus.betaMessage', '정식 출시에 앞서 추가 성능과 협업 기능을 다듬고 있어요.')}
                  </p>
        ...
        <span className="text-3xl font-extrabold text-slate-900">
          {t('plus.price', '₩1,900')}
                    ...
                    <span className="text-sm text-slate-500">{t('plus.per', '/ 월')}</span>
                  </div>
          ...
          {/*        <ul className="mt-6 space-y-3.5 text-sm text-slate-800">*/}
          {/*          <li className="flex items-center gap-3 group/item">*/}
          {/*            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-indigo-100 to-indigo-200 ring-1 ring-slate-200">*/}
          {/*              <BadgeCheck className="text-indigo-600" size={12} />*/}
          {/*            </div>*/}
          {/*            <span className="group-hover/item:text-indigo-700 transition-colors">*/}
          {/*  {t('pro.features.sessions', '월 500회 이미지 분석 세션 제공 (예정)')}*/}
          {/*</span>*/}
          {/*          </li>*/}

          {/*          <li className="flex items-center gap-3 group/item">*/}
          {/*            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-purple-100 to-indigo-100 ring-1 ring-slate-200">*/}
          {/*              <Sparkles className="text-purple-600" size={12} />*/}
          {/*            </div>*/}
          {/*            <span className="group-hover/item:text-indigo-700 transition-colors">*/}
          {/*  {t('pro.features.queue', '전용 고속 처리 큐 & 성능 보장 (예정)')}*/}
          {/*</span>*/}
          {/*          </li>*/}

          {/*          <li className="flex items-center gap-3 group/item">*/}
          {/*            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-indigo-100 to-emerald-100 ring-1 ring-slate-200">*/}
          {/*              <BarChart3 className="text-emerald-600" size={12} />*/}
          {/*            </div>*/}
          {/*            <span className="group-hover/item:text-indigo-700 transition-colors">*/}
          {/*  {t('pro.features.metrics', '심층 분석 지표 & 알림 기능 (예정)')}*/}
          {/*</span>*/}
          {/*          </li>*/}

          {/*          <li className="flex items-center gap-3 group/item">*/}
          {/*            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-blue-100 to-indigo-100 ring-1 ring-slate-200">*/}
          {/*              <Layers3 className="text-indigo-500" size={12} />*/}
          {/*            </div>*/}
          {/*            <span className="group-hover/item:text-indigo-700 transition-colors">*/}
          {/*  {t('pro.features.models', '최신 모델 & 프리셋 지원 (예정)')}*/}
          {/*</span>*/}
          {/*          </li>*/}

          {/*          /!* 추가 항목: 히스토리 + 공유 *!/*/}
          {/*          <li className="flex items-center gap-3 group/item">*/}
          {/*            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-indigo-50 to-slate-50 ring-1 ring-slate-200">*/}
          {/*              <History className="text-indigo-500" size={12} />*/}
          {/*            </div>*/}
          {/*            <span className="group-hover/item:text-indigo-700 transition-colors">*/}
          {/*  {t('pro.features.history', '분석 이력 및 비교 기능 (예정)')}*/}
          {/*</span>*/}
          {/*          </li>*/}

          {/*          <li className="flex items-center gap-3 group/item">*/}
          {/*            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-violet-100 to-indigo-100 ring-1 ring-slate-200">*/}
          {/*              <Share2 className="text-indigo-600" size={12} />*/}
          {/*            </div>*/}
          {/*            <span className="group-hover/item:text-indigo-700 transition-colors">*/}
          {/*  {t('pro.features.share', '결과 공유 & 팀 협업 기능 (예정)')}*/}
          {/*</span>*/}
          {/*          </li>*/}
          {/*        </ul>*/}
                  ...
                  <div className="mt-auto pt-6">
                    <div
                        className="inline-flex w-full items-center justify-center rounded-lg bg-indigo-600/10 px-4 py-2.5 text-sm font-semibold text-indigo-700 shadow-sm cursor-not-allowed hover:bg-indigo-600/15 transition-colors"
                        aria-disabled="true"
                    >
                      {t('plus.ctaDisabled', '출시 준비 중')}
                    </div>
                    <p className="mt-3 text-xs text-slate-500 text-center">
                      {t('plus.notice', '플러스 요금제가 열리면 가장 먼저 안내드릴게요.')}
                    </p>
                  </div>
                </motion.div>
              </div>
            ...
            {/* Pro */}
            <div className="w-full">
              <div className="relative h-full rounded-2xl bg-gradient-to-br from-indigo-300/30 via-purple-200/35 to-indigo-100/25 p-[1px]">
                <motion.div
                    className="group rounded-2xl bg-gradient-to-br from-white/97 via-indigo-100/85 to-purple-50/80 backdrop-blur-sm ring-1 ring-indigo-300/70 p-6 md:p-8 shadow-md hover:shadow-xl transition-all flex flex-col h-full"
                    initial={getInitial(24)}
                    animate={animateProps}
                    transition={getTransition(0.06)}
                >
                  ...
                  {/*</h3>*/}
                  <p className="mt-1 text-sm text-slate-600">
                    {t('pro.subtitle', '정식 출시 직전에 마지막 검증을 진행하고 있어요.')}
                  </p>

                  {/* 안내 문구 */}
                  <p className="mt-3 text-xs font-medium text-indigo-600">
                    {t('pro.betaMessage', '현재는 Free 플랜을 통해 동일한 분석 기능을 경험해 주세요.')}
                  </p>
        ...
        <span className="text-3xl font-extrabold text-slate-900">
          {t('pro.price', '준비 중')}
                  ...
                  {/* 구분선 */}
                  <div className="mt-5 h-px w-full bg-gradient-to-r from-transparent via-slate-300 to-transparent" />
                  ...
                  <div className="mt-auto pt-6">
                    <div
                        className="inline-flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-indigo-600/20 to-purple-500/20 px-4 py-2.5 text-sm font-semibold text-indigo-800 shadow-sm cursor-not-allowed hover:from-indigo-600/25 hover:to-purple-500/25 transition-colors"
                        aria-disabled="true"
                    >
                      {t('pro.ctaDisabled', '출시 준비 중')}
                    </div>
                    <p className="mt-3 text-xs text-slate-500 text-center">
                      {t('pro.notice', '비공개 테스트가 완료되면 바로 안내드릴게요.')}
                    </p>
                  </div>
                </motion.div>
              </div>
