...
export default function SupportedInputsSection() {
    ...
    return (
        ...
        >
            <div
                className="pointer-events-none absolute inset-0 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 dark:from-slate-950 dark:via-indigo-900/70 dark:to-slate-950"
                aria-hidden="true"
            />
            <div
                className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(129,140,248,0.35),_transparent_65%)] dark:bg-[radial-gradient(circle_at_top,_rgba(99,102,241,0.35),_transparent_65%)]"
                aria-hidden="true"
            />

            <div className="relative mx-auto max-w-6xl px-6 text-slate-100">
                <div className="mx-auto max-w-3xl text-center">
                    <h3 className="text-[11px] font-semibold uppercase tracking-[0.3em] text-indigo-300 sm:text-xs">
                        {t("supported.eyebrow", "What you can upload")}
                    </h3>
                    <p className="mt-3 text-xl font-bold tracking-tight text-white sm:text-3xl md:text-4xl">
                        {t("supported.title", "Supported formats & sizes")}
                    </p>
                    <p className="mt-4 text-[13px] leading-relaxed text-indigo-100/90 sm:text-base md:text-lg">
                ...
                <div className="mx-auto mt-10 flex flex-wrap justify-center gap-2">
                    {badges.map((label) => (
                        <span
                            key={label}
                            className="rounded-full bg-indigo-500/20 px-4 py-1.5 text-xs font-semibold text-indigo-100 shadow-sm shadow-indigo-500/20"
                        >
                            {label}
                        </span>
                    ))}
                ...
                <div className="mx-auto mt-10 grid max-w-4xl gap-6 sm:grid-cols-2">
                    <article className="rounded-3xl border border-indigo-400/30 bg-white/5 p-6 shadow-lg shadow-black/30 backdrop-blur transition hover:-translate-y-1 hover:shadow-2xl">
